...
tools:
  ['edit/createFile', 'edit/createDirectory', 'edit/editFiles', 'search/fileSearch', 'search/listDirectory', 'search/readFile', 'runCommands', 'Microsoft Docs/*', 'Bicep (EXPERIMENTAL)/*', 'Azure MCP/*', 'fetch', 'todos']
---
